#!/bin/bash
# ==============================================================
# 追加 128mb / 256mb 实验到 experiments_v2 结果 CSV
# 用法: bash experiments_v2/run_new_sizes.sh <sr|gbn>
# 不清空已有 CSV，只追加新行
# ==============================================================
set -e
cd "$(dirname "$0")/.."

PROTOCOL=${1:?用法: bash experiments_v2/run_new_sizes.sh <sr|gbn>}
CSV="experiments_v2/${PROTOCOL}/results.csv"

ERR_RATES="0.00001 0.00005 0.0001 0.0005 0.001"
MSG_SIZES="128mb 256mb"
